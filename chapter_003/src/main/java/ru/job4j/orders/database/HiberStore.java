...
//		    .addAnnotatedClass(OrderImage.class)
	...
	public Order[] getOrders() {
		...
		try {
			session = sessionFactory.openSession();
			orders = (List<Order>) session.createNamedQuery("selectOrders").list();
		} catch (Exception ex) {
	...
	public Order[] getNotRdyOrders() {
		...
		try {
			session = sessionFactory.openSession();
			orders = (List<Order>) session.createNamedQuery("selectNotRdyOrders").list();
		} catch (Exception ex) {
